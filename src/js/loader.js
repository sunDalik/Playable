...
export function loadAll(afterLoad) {
    Game.loader
        ...
        .add("src/images/tilesets/void_tileset/void_floor_tile_0.png")
        .add("src/images/tilesets/void_tileset/void_floor_tile_1.png")
        .add("src/images/tilesets/void_tileset/void_floor_tile_side_0.png")
        .add("src/images/tilesets/void_tileset/void_floor_tile_side_1.png")
        .add("src/images/tilesets/void_tileset/void_floor_tile_up_0.png")
        .add("src/images/tilesets/void_tileset/void_floor_tile_up_1.png")
        .add("src/images/tilesets/void_tileset/void_floor_tile_corner_0.png")
        .add("src/images/tilesets/void_tileset/void_floor_tile_corner_1.png")
