...
export function loadAll(afterLoad) {
    Game.loader
        ...
        .add("src/images/enemies/spiky_wall_trap_x_triggered.png")
        .add("src/images/enemies/spiky_wall_trap_x_attacked.png")
        .add("src/images/enemies/spiky_wall_trap_x_unready.png")
        .add("src/images/enemies/spiky_wall_trap_top.png")
        .add("src/images/enemies/spiky_wall_trap_top_triggered.png")
        .add("src/images/enemies/spiky_wall_trap_top_attacked.png")
        .add("src/images/enemies/spiky_wall_trap_top_unready.png")
        .add("src/images/enemies/spiky_wall_trap_bottom.png")
        .add("src/images/enemies/spiky_wall_trap_bottom_triggered.png")
