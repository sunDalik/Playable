...
import {ShrineOfImp} from "../classes/inanimate_objects/shrines/shrine_of_imp";
...
export function generateStandard() {
    ...
    let attempt = 0;
    const secretRoomsAmount = Game.stage === STAGE.FLOODED_CAVE || Game.stage === STAGE.DRY_CAVE ? 0 : 0;
