...
import {EQUIPMENT_ID, SLOT} from "../../../enums/enums";
...
export class ShrineOfCurse extends Shrine {
    ...
    interact(player) {
        ...
        playerEquipment = playerEquipment.filter(eq => eq !== null && eq.enchantment === ENCHANTMENT_TYPE.NONE && eq.id !== EQUIPMENT_ID.TORCH);
