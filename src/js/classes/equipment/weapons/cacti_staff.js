...
export class CactiStaff extends MinionStaff {
    constructor() {
        ...
        this.description = "3 cactus minions will damage enemies that stand on its tile\nMinion's atk is 1 (x2 if in WEAPON slot) and does not depend on normal atk stats";
        this.rarity = RARITY.B;
        this.minions = [new CactiStaffMinion(), new CactiStaffMinion(), new CactiStaffMinion()];
